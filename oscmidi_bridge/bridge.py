...
# when Bome tombe. On se branche sur l'existant et on filtre sur le channel_.
...
class Bridge:
    ...
    def _open_midi(self):
        ...
        if i_in is None or i_out is None:
            ...
            # when même. Elle ne sert alors à rien, mais elle le DIT et elle ne
    ...
    def _subscribe(self):
        ...
        Il faut donc un `start_listen` ET un `get` initial, sinon l'état rest vide
    ...
    def run(self):
        ...
        while not self._stop.is_set():
            ...
            # reecrirait le fichier a chaque message received — le meme reflexe que le
